  ...
  return (
    <div className="bg-background text-foreground">
      ...
      >
        ...
        versatile as a mug, or as specific as a sculpture designed to hold a pole upright, I ensure
        the art I make has a use.` }
      </StorySection>
      <StorySection
      ...
      >
        { `I make my ceramics by wheel and hand, giving each item a unique combination of expression,
        size, and color. Sometimes I draw on paper a prototype of the expression I want to give a
        particular piece (the face icons displayed on this site are examples of that). Other times I
        let the clay guide me to an expression I hadn't yet imagined.` }
      </StorySection>
