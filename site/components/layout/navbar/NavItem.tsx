...
// ────────────────────────────────────────────────────────────────
//
function MobileNavItem({ name, href, icon, dropdown, closeMobileMenu }: NavItemProps) {
  const pathname = usePathname();
  const [open, setOpen] = useState(false);

  const hasDropdown = dropdown && dropdown.length > 0;
  const isActive = pathname === href || dropdown?.some((item) => item.href === pathname);
...
// ────────────────────────────────────────────────────────────────
//
function DesktopNavItem({ name, href, icon, dropdown }: NavItemProps) {
  const pathname = usePathname();
